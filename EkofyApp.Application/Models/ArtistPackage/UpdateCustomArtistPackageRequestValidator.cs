...
{
    public sealed class UpdateCustomArtistPackageRequestValidator : AbstractValidator<UpdateCustomArtistPackageRequest>
    {
        public UpdateCustomArtistPackageRequestValidator()
        {
            RuleFor(x => x.Amount)
