...
{
    public string Name { get; init; } = default!; // Name of the playlist, e.g., "Chill Vibes"
    public string Description { get; init; } = default!; // Description of the playlist, e.g., "A collection of relaxing tunes"
